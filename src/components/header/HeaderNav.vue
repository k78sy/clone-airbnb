...
const nav = [
  {
    icon: 'https://a0.muscache.com/videos/search-bar-icons/webm/house-selected.webm',
    name: '숙소',
  },
  {
    icon: 'https://a0.muscache.com/videos/search-bar-icons/webm/balloon-selected.webm',
    name: '체험',
  },
  {
    icon: 'https://a0.muscache.com/videos/search-bar-icons/webm/consierge-selected.webm',
    name: '서비스',
  },
]
</script>
